        ...
        <footer className="ex-footer">
          <div className="ex-footer-top">
            ...
            <div className="ex-footer-col ex-footer-col-news">
              ...
              <p className="ex-footer-consent">Al suscribirte aceptás nuestra <a href="#" className="ex-footer-flink">política de privacidad</a>.</p>
            </div>
            ...
            <div className="ex-footer-col">
              ...
              <ul className="ex-footer-list">
                {['Garantía de satisfacción', 'Devoluciones', 'Envíos a Colombia', 'Métodos de pago'].map((item) => (
                  <li key={item}><span className="ex-footer-list-item">{item}</span></li>
                ))}
              </ul>
            </div>
            ...
            <div className="ex-footer-col">
              ...
              <ul className="ex-footer-list">
                ...
                <li>
                  <a href="https://wa.me/573243520379" target="_blank" rel="noopener noreferrer" className="ex-footer-wa-link">
              ...
              <div className="ex-footer-social">
                {[
                  ...
                  <a key={label} href="#" aria-label={label} className="ex-footer-social-btn">
