          ...
          {isProducto && !sinStock && (
            <span className="ft-card-stock">
              <span className="ft-stock-bar">
                <span className="ft-stock-fill" style={{ width: stockBajo ? '20%' : '80%', background: stockBajo ? '#FF3D00' : 'var(--ft-accent, #39FF14)' }} />
              </span>
...
export default function FitnessStore({ slug: slugProp, tenantSlug }) {
  ...
  const cssVars = {
    '--ft-accent': colorPrimario  || '#39FF14',
    '--ft-bg':     colorSecundario || '#0A0A0A',
    '--ft-text':   colorTexto     || '#F0F0F0',
  }
      ...
      <div className="ft-root" style={cssVars}>
        ...
        <header className="ft-header">
          <div className="ft-header-inner">
            ...
            <div className="ft-search-area">
              <div className="ft-search-box">
                ...
                {busqueda && (
                  <button type="button" className="ft-search-x" onClick={() => setBusqueda('')}>âœ•</button>
                )}
              </div>
          ...
          {searchOpen && (
            <div className="ft-mob-search">
              <input ref={mobileInputRef} type="text" placeholder="Â¿QuÃ© buscas?" value={busqueda} onChange={(e) => setBusqueda(e.target.value)} />
            </div>
          )}
        </header>
        ...
        <section className="ft-hero">
          ...
          <div className="ft-hero-content">
            ...
            <p className="ft-hero-sub">{tagline ? tagline.toUpperCase() : 'POTENCIA TU RENDIMIENTO. SIN EXCUSAS.'}</p>
            {!loading && (
        ...
        {categorias.length > 0 && (
          <section className="ft-cat-section">
            <div className="ft-cat-header">
              ...
              <span className="ft-cat-label">CATEGORÃAS</span>
              <div className="ft-cat-line" />
            </div>
          ...
          <div className="ft-grid">
            {loading ? (
              ...
              <div className="ft-empty">
                <div className="ft-empty-icon">âˆ…</div>
        ...
        <footer className="ft-footer">
          <div className="ft-footer-inner">
            ...
            <span className="ft-footer-copy">Â© {new Date().getFullYear()} Todos los derechos reservados</span>
...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ft-brand-badge { font-family: 'Barlow Condensed', sans-serif; font-size: 9px; font-weight: 700; letter-spacing: 0.2em; padding: 3px 8px; border: 1px solid var(--ft-accent, #39FF14); color: var(--ft-accent, #39FF14); }
  ...
  .ft-search-box input:focus { border-color: var(--ft-accent, #39FF14); background: rgba(57,255,20,0.03); }
  ...
  .ft-mob-search input:focus { border-color: var(--ft-accent, #39FF14); }
  ...
  .ft-hero-tag { font-family: 'Barlow Condensed', sans-serif; font-size: 12px; font-weight: 600; letter-spacing: 0.25em; color: var(--ft-accent, #39FF14); display: block; margin-bottom: 12px; }
  ...
  .ft-counter-num { font-family: 'Oswald', sans-serif; font-size: 36px; font-weight: 500; color: var(--ft-accent, #39FF14); line-height: 1; }
  ...
  .ft-hero-clip { position: absolute; bottom: 0; left: 0; right: 0; height: 3px; background: linear-gradient(90deg, var(--ft-accent, #39FF14), transparent 70%); }
  ...
  .ft-cat-label {
    ...
    color: var(--ft-accent, #39FF14); flex-shrink: 0;
  }
  .ft-cat-grid {
  ...
  .ft-cat-card::after {
    ...
    background: var(--ft-accent, #39FF14);
    transform: scaleX(0);
  ...
  .ft-subcat-active {
    color: var(--ft-accent, #39FF14) !important;
  ...
  .ft-subcat-active .ft-subcat-count { color: var(--ft-accent, #39FF14); background: rgba(57,255,20,0.1); }
  ...
  .ft-card-cta { position: absolute; bottom: 20px; left: 0; right: 0; display: flex; align-items: center; justify-content: center; gap: 8px; font-family: 'Barlow Condensed', sans-serif; font-size: 12px; font-weight: 700; letter-spacing: 0.18em; color: var(--ft-accent, #39FF14); transition: all 0.3s cubic-bezier(.25,.8,.25,1); z-index: 3; }
  .ft-arr { position: absolute; top: 50%; transform: translateY(-50%); width: 32px; height: 32px; background: rgba(0,0,0,0.7); border: 1px solid rgba(57,255,20,0.2); color: var(--ft-accent, #39FF14); font-size: 20px; cursor: pointer; display: flex; align-items: center; justify-content: center; z-index: 5; transition: all 0.15s; line-height: 1; padding: 0; }
  ...
  .ft-card-price { font-family: 'Oswald', sans-serif; font-size: 20px; font-weight: 500; color: var(--ft-accent, #39FF14); letter-spacing: 0.02em; line-height: 1; }
  ...
  .ft-card-line { position: absolute; bottom: 0; left: 0; right: 0; height: 2px; background: var(--ft-accent, #39FF14); transform-origin: left; transition: transform 0.3s; }
  ...
  .ft-footer-neon { font-family: 'Barlow Condensed', sans-serif; font-size: 10px; font-weight: 700; letter-spacing: 0.2em; color: var(--ft-accent, #39FF14); opacity: 0.4; }
