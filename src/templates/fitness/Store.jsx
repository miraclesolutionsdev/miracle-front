...
const CSS = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .ft-card-img { position: relative; padding-bottom: 110%; overflow: hidden; background: #0D0D0D; }
  ...
  .ft-card-info { padding: 16px 18px 18px; }
  .ft-card-name { font-family: 'Barlow', sans-serif; font-size: 14px; font-weight: 500; color: #ccc; line-height: 1.4; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical; overflow: hidden; margin-bottom: 10px; }
  .ft-card-bottom { display: flex; align-items: center; justify-content: space-between; gap: 8px; }
  .ft-card-price { font-family: 'Oswald', sans-serif; font-size: 24px; font-weight: 500; color: #39FF14; letter-spacing: 0.02em; line-height: 1; }
  ...
  .ft-sk-img { padding-bottom: 110%; }
  .ft-sk-body { padding: 16px 18px; display: flex; flex-direction: column; gap: 10px; }
  ...
  /* RESPONSIVE */
  @media (max-width: 1100px) { .ft-grid { grid-template-columns: repeat(2, 1fr); } }
