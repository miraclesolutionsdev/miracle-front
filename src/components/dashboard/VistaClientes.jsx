...
import ClientesList from './tables/ClientesList'
import ClienteForm from '../forms/ClienteForm'
import ClienteDetalle from './tables/ClienteDetalle'
...
export default function VistaClientes() {
  ...
  const handleGuardarCliente = async (payload) => {
    ...
    try {
      ...
      alertError(err.message || 'No se pudo guardar el cliente')
    }
  }
  ...
  const handleImportExcel = async (file) => {
    try {
      ...
      if (!validacion.valido) {
        alertError('Faltan columnas: ' + validacion.faltantes.join(', ') + '. Revisa la primera fila del Excel.')
        return
      }
