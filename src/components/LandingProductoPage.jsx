...
function ImageGallery({ producto }) {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="relative overflow-hidden rounded-2xl bg-[#141418] ring-1 ring-white/[0.06]">
        <img
        ...
        <div className="flex gap-3">
          {images.map((src, i) => (
            <button
              ...
              className={`relative aspect-square w-20 overflow-hidden rounded-xl ring-2 transition-all duration-200 ${
                i === selectedIndex
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="rounded-2xl bg-[#141418] p-6 ring-1 ring-white/[0.06] sm:p-8">
              {!showWhatsappForm ? (
                <button
                  type="button"
                  onClick={() => setShowWhatsappForm(true)}
                  className="flex w-full flex-col items-center gap-5 rounded-xl border border-dashed border-[#25D366]/30 bg-[#25D366]/[0.04] py-10 transition-all duration-200 hover:border-[#25D366]/60 hover:bg-[#25D366]/[0.08] focus:outline-none focus:ring-2 focus:ring-[#25D366]/30 focus:ring-offset-2 focus:ring-offset-[#141418]"
                  aria-label="Abrir formulario de contacto por WhatsApp"
                >
                  <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#25D366] text-white shadow-lg shadow-[#25D366]/20">
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-white/40">
                        Completa tus datos y te redirigimos al chat.
                      </p>
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleWhatsapp} className="flex flex-col gap-4">
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full rounded-xl border border-white/[0.08] bg-white/[0.04] px-4 py-3 text-sm text-white placeholder:text-white/25 transition-colors focus:border-[#25D366]/40 focus:outline-none focus:ring-1 focus:ring-[#25D366]/20"
                    ...
                    <button
                      type="submit"
                      className="flex items-center justify-center gap-2 rounded-xl bg-[#25D366] px-5 py-3.5 text-sm font-semibold text-white shadow-md shadow-[#25D366]/20 transition-all duration-200 hover:bg-[#20BD5A] focus:outline-none focus:ring-2 focus:ring-[#25D366]/40 focus:ring-offset-2 focus:ring-offset-[#141418]"
                    >
                      <WhatsAppIcon className="h-5 w-5" />
                      Ir a WhatsApp
                    </button>
                  ...
                  <button
                    ...
                    className="self-start text-sm text-white/30 underline transition-colors hover:text-white/60"
                  >
                    Cerrar formulario
                  </button>
                </div>
