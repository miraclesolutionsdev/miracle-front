      ...
      <header className="fixed top-0 left-0 right-0 z-30 flex h-14 items-center justify-between border-b border-border bg-card/90 backdrop-blur-xl px-6">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <button
            ...
            className="flex h-8 items-center gap-2 rounded-lg border border-border bg-muted/50 px-3 text-[12px] text-muted-foreground transition-colors hover:bg-accent hover:text-foreground"
            aria-label="Buscar"
          >
            <Search className="h-3.5 w-3.5" />
            <span className="hidden sm:inline">Buscar...</span>
            <kbd className="hidden sm:inline-flex h-4 select-none items-center rounded border border-border bg-background px-1 font-mono text-[10px] text-muted-foreground">
              /
            </kbd>
          </button>
          ...
          <div className="relative" ref={notifRef}>
            ...
            {notifOpen && (
              <div className="absolute right-0 top-full z-50 mt-2 w-72 rounded-xl border border-border bg-popover shadow-xl shadow-black/10">
